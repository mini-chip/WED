            ...
            >
                ...
                <div className="w-full">
                    <input
                        ...
                        placeholder="아이디"
                    />
                    {errors.userId && <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.userId.message}</p>}
                </div>
                ...
                <div className="w-full">
                    ...
                    {errors.passwordCheck && (
                        <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.passwordCheck.message}</p>
                    )}
                </div>
                ...
                <div className="w-full">
                    ...
                    />
                    {errors.nickname && (
                        <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.nickname.message}</p>
                    )}
                </div>
                ...
                <div className="w-full flex items-center gap-2">
                    ...
                    {errors.agree && <p className="text-red-500 text-xs sm:text-sm">{errors.agree.message}</p>}
                </div>
                ...
                {/* 에러 메시지 */}
                {signupError && <p className="text-red-500 text-xs sm:text-sm mt-2">{signupError}</p>}
