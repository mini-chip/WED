...
<img alt='Next.js14' src='https://img.shields.io/badge/Next.js14-000000.svg?&style=for-the-badge&logo=Next.js&logoColor=white'/>
...
- 사용자 맞춤 설정: 개인의 선호 스타일을 반영한 추천 기능 (개발 자원 확보 시).
- 더 많은 음악 소스: Spotify 외에 다른 스트리밍 서비스 연동 또는 사용자 업로드 옵션 (저작권 문제 해결 후).
...
1. 저장소 클론
   ...
   ```bash
   git clone https://github.com/mini-chip/weather_shopping.git
   ```
